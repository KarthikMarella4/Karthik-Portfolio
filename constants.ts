...
export const SKILLS: Skill[] = [
  ...
  { id: 2, title: "Cloud & DevOps", detail: "AWS / Azure / DVC / Docker / Jenkins / GitHub Actions / Prometheus / Grafana" },
  { id: 3, title: "Backend & API", detail: "Python / FastAPI / Flask / Django / SQL" },
  { id: 4, title: "Tools & Platforms", detail: "NumPy / Pandas / Git / MLflow / Airflow / n8n / ETL" },
];
